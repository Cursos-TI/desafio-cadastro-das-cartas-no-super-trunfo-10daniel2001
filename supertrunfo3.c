...
int main() {
    ...
    // Comparações
    printf("\n--- COMPARAÇÕES ---\n");
    printf("População: Carta 01 %s\n", populacao01 > populacao02 ? "VENCEU" : "PERDEU");
    printf("Área: Carta 01 %s\n", area01 > area02 ? "VENCEU" : "PERDEU");
    printf("PIB: Carta 01 %s\n", pib01 > pib02 ? "VENCEU" : "PERDEU");
    printf("Pontos Turísticos: Carta 01 %s\n", pontosturisticos01 > pontosturisticos02 ? "VENCEU" : "PERDEU");
    printf("Densidade: Carta 01 %s\n", densidade01 < densidade02 ? "VENCEU" : "PERDEU"); // menor densidade vence
    printf("PIB per capita: Carta 01 %s\n", pib_per_capita01 > pib_per_capita02 ? "VENCEU" : "PERDEU");
